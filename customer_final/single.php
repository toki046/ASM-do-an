	...
	<div class="productFeedback">
		...
		<form method="POST">
			<div class="input-feedback">
				<textarea type ="text" cols="5" rows="5" class="input-description" placeholder="Input your feedback" name="commentContent"></textarea>
				<input type="text" class="input-user" placeholder="Input name" name="commentUser">
				<input type="number" class="input-user" placeholder="Input phone number" name="commentPhone">
				<input type="email" class="input-user" placeholder="Input Email" name="commentEmail">
