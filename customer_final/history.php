        ...
        <div class="right-content">
            <div class="d-flex flex-row align-items-center">
                ...
                <div class="d-flex flex-column mt-4">
                    <button class="btn-voucher btn-primary btn-sm" type="button">Repurchase</button>
...
?>
    <h3 style="text-align:center; margin-top: 100px;">Bạn cần đăng nhập để xem nội dung này</h3>
<?php
    }
?>
