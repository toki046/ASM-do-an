...
<footer>
		<div class="container">
			...
			<div class="footer-info w3-agileits-info">
				...
				<div class="col-sm-5 address-right">
					...
					<div class="col-xs-6 footer-grids">
						...
						<ul>
							<li>
								<i class="fa fa-map-marker"></i> 123 Cau Giay, Ha Noi</li>
							<li>
								<i class="fa fa-mobile"></i> 0123456789 </li>
							<li>
								<i class="fa fa-phone"></i> +0123456789 </li>
							<li>
								<i class="fa fa-envelope-o"></i>
								<a href="mailto:example@mail.com"> group30000@gamil.com</a>
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="col-sm-2 footer-grids  w3l-socialmk">
					...
					<div class="agileits_app-devices">
						...
						<a href="#">
							<img src="../shared_assets/img/1.png" alt="">
						</a>
						<a href="#">
							<img src="../shared_assets/img/2.png" alt="">
						</a>
						<div class="clearfix"> </div>
					</div>
				</div>
			...
			<div class="agile-sometext">
				...
				<div class="sub-some">
					...
					<p>Now Get Upto 40% Off On Everyday Essential Products Shown On The Offer Page. The range includes Shop, Personal Care,
				...
				<div class="sub-some child-momu">
					...
					<ul>
						<li>
							<img src="../shared_assets/img/pay2.png" alt="">
						</li>
						<li>
							<img src="../shared_assets/img/pay5.png" alt="">
						</li>
						<li>
							<img src="../shared_assets/img/pay1.png" alt="">
						</li>
						<li>
							<img src="../shared_assets/img/pay4.png" alt="">
						</li>
						<li>
							<img src="../shared_assets/img/pay6.png" alt="">
						</li>
						<li>
							<img src="../shared_assets/img/pay3.png" alt="">
						</li>
						<li>
							<img src="../shared_assets/img/pay7.png" alt="">
						</li>
						<li>
							<img src="../shared_assets/img/pay8.png" alt="">
						</li>
						<li>
							<img src="../shared_assets/img/pay9.png" alt="">
						</li>
					</ul>
				</div>
				<!-- //payment -->
	...
	<!-- js-files -->
	<!-- jquery -->
	<script src="../shared_assets/js/jquery-2.1.4.min.js"></script>
	<!-- //jquery -->

	<!-- popup modal (for signin & signup)-->
	<script src="../shared_assets/js/jquery.magnific-popup.js"></script>
	<script>
	...
	<!-- cart-js -->
	<script src="../shared_assets/js/minicart.js"></script>
	
	<!-- //cart-js -->

	<!-- easy-responsive-tabs -->
	<link rel="stylesheet" type="text/css" href="css/easy-responsive-tabs.css " />
	<script src="../shared_assets/js/easyResponsiveTabs.js"></script>
	...
	<!-- credit-card -->
	<script src="../shared_assets/js/creditly.js"></script>
	<link rel="stylesheet" href="../shared_assets/css/creditly.css" type="text/css" media="all" />
	...
	<script src="../shared_assets/js/jquery-ui.js"></script>
	<script>
		//<![CDATA[ 
	...
	<!-- smoothscroll -->
	<script src="../shared_assets/js/SmoothScroll.min.js"></script>
	<!-- //smoothscroll -->

	<!-- start-smooth-scrolling -->
	<script src="../shared_assets/js/move-top.js"></script>
	<script src="../shared_assets/js/easing.js"></script>
	<script>
	...
	<!-- imagezoom -->
	<script src="../shared_assets/js/imagezoom.js"></script>
	<!-- //imagezoom -->

	<!-- FlexSlider -->
	<script src="../shared_assets/js/jquery.flexslider.js"></script>
	<script>
	...
	<script src="../shared_assets/js/jquery.flexisel.js"></script>
	<script>
		$(window).load(function () {
	...
	<script src="../shared_assets/js/bootstrap.js"></script>
	<!-- //for bootstrap working -->
	<!-- //js-files -->
